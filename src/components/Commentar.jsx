    ...
    const handleImageChange = useCallback((e) => {
        ...
        if (file) {
            if (file.size > 5 * 1024 * 1024) {
                swal({ title: "File too large", text: "Image must be less than 5MB. Please choose a smaller file.", icon: "warning" });
                if (e.target) e.target.value = '';
                return;
            }

            if (!file.type.startsWith('image/')) {
                swal({ title: "Invalid file", text: "Please select a valid image file (JPG, PNG, WEBP, etc).", icon: "warning" });
                if (e.target) e.target.value = '';
                return;
            }
    ...
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        ...
        try {
            ...
            swal({
                ...
                text: "Thanks for leaving a message.",
                icon: "success",
                timer: 2000,
    ...
    return (
        <div className="w-full bg-gradient-to-b from-white/10 to-white/5 rounded-2xl  backdrop-blur-xl shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="space-y-4 h-[220px] sm:h-[280px] md:h-[328px] overflow-y-auto overflow-x-hidden custom-scrollbar pt-1 pr-1 " data-aos="fade-up" data-aos-delay="200">
                    {/* Pinned Comment */}
                    {pinnedComment && (
