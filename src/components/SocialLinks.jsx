...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/tisna-hidayat-778084203/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@tisnahidayat_",
    icon: Instagram,
    url: "https://www.instagram.com/tisnahidayat_/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@tisnahidayat15",
    icon: Youtube,
    url: "https://www.youtube.com/@tisnahidayat15",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@tisnahidayat",
    icon: Github,
    url: "https://github.com/tisnahidayat",
    color: "#ffffff",
  ...
  },
  {
    name: "TikTok",
    displayName: "Tiktok",
    subText: "@sudahmakanteruspulang_",
    ...
    url: "https://www.tiktok.com/@sudahmakanteruspulang_",
    color: "black",
